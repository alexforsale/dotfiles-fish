...
** 99-nord-theme.fish
:PROPERTIES:
:header-args: :tangle .config/fish/conf.d/99-nord-theme.fish :padline no :shebang #!/usr/bin/env fish
:END:

#+begin_src fish
  #!/usr/bin/env fish
  # ~/.config/fish/conf.d/99-nord-theme.fish
  # Nord Theme for fish shell
  # from https://github.com/nordtheme/nord/issues/102
  # <alexforsale@yahoo.com>
